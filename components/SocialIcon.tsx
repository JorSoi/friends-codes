...
function SocialIcon({type, userURL, user} : {type : string, userURL : string, user : any}) {

    const shareLinks : any = {
        whatsapp: `whatsapp://send?text=Take a look at my referral codes using this link: ${userURL} `,
        twitter: `https://twitter.com/share?text=Take a look at the referral codes from ${user.user_name}!&url=${userURL}&hashtags=referralcodes`,
        facebook: `https://www.facebook.com/sharer/sharer.php?u=${userURL}&quote=Take a look at my referral codes using this link:`,
        telegram: `https://telegram.me/share/url?url=${userURL}&text=Take a look at the referral codes from ${user.user_name}!`,
